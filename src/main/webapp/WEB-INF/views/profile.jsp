                        ...
                        <form method="post" class="user">
                            <div class="form-group row ">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    First name:
                                    <input type="text" class="form-control form-control-user" name="firstName" value="${user.firstName}">
                                </div>
                                <div class="col-sm-6">
                                    Last name:
                                    <input type="text" class="form-control form-control-user" name="lastName" value="${user.lastName}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                Nick name:
                                <input type="text" class="form-control form-control-user" name="nickName" value="${user.nickName}">
                            </div>
