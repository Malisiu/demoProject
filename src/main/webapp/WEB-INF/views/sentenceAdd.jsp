        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="/app/category" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                ...
                <div class="row justify-content-center">
                    ...
                    <form method="post" action="/app/sentenceAdd/${categoryId}" class="padding-small text-center">
                        <h1 class="text-color-darker">Add word</h1>
                        <div class="form-group">
                            Write english word:
                            <input type="text" class="form-control" name="sentenceEn" placeholder="sentenceEn">
                        </div>
                        <div class="form-group">
                            Write polish word:
                            <input type="text" class="form-control" name="sentencePl" placeholder="sentencePl">
                        </div>
