        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <form method="post" action="/app/wordAdd/${categoryId}" class="padding-small text-center">
                        <h1 class="text-color-darker">Add word</h1>
                        <div class="form-group">
                            Write english word:
                            <input type="text" class="form-control" name="wordEn" placeholder="wordEn">
                        </div>
                        <div class="form-group">
                            Write polish word:
                            <input type="text" class="form-control" name="wordPl" placeholder="wordPl">
                        </div>
