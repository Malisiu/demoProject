            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                        <tr>
                            <th><p class="text-center">Basic categories</p></th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <c:forEach items="${basic}"  var="info">
                            <tr>
                                <td>
                                    <p class="text-center text-primary">${info.name}</p>
                                    <p class="text-right ">
                                        <a href="/app/category/words/${info.id}" class="text-warning">Words</a>
                                        <a href="/app/category/sentence/${info.id}" class="text-warning">Sentence</a>
                                    </p>
                                </td>
                            </tr>
                        </c:forEach>
                        ...
                        <thead>
                        <tr>
                            <th><p class="text-center">Own categories</p></th>
                        </tr>
                        </thead>
                        <tbody>

                        <c:forEach items="${noBasic}"  var="info">
                            <tr>
                                <td>
                                    <p class="text-center text-primary">${info.name}</p>
                                    <p class="text-right ">
                                        <a href="/app/category/words/own/${info.id}" class="text-warning">Words</a>
                                        <a href="/app/category/sentence/own/${info.id}" class="text-warning">Sentence</a>
                                        <a href="/app/category/${info.id}" class="text-danger">Remove</a>
                                    </p>
                                </td>
                            </tr>
                        </c:forEach>
