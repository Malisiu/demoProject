        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <a href="/app/wordAdd/${categoryId}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-download fa-sm text-white-50"></i> Add word</a>
                </div>
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                        <tr>
                            <th><p class="text-center">Polish Word</p></th>
                            <th><p class="text-center">English Word</p></th>
                        ...
                        <c:forEach items="${words}"  var="info">
                            <tr>
                                <td>
                                    <p class="text-center text-primary ">${info.wordPl}</p>
                                </td>
                                <td>
